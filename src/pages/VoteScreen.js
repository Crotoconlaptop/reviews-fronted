...
const categories = [
    { id: 'HR', description: 'HUMAN RESOURCES: evaluates how attentive HR is to employees needs, whether they address concerns promptly, and whether they treat staff with respect and care. 1 star = bad HR support, 5 stars = excellent HR support' },
    { id: 'FRONT DESK', description: 'FRONT DESK: focuses on whether Front Desk staff respect other sectors, communicate politely, and collaborate effectively without causing unnecessary friction. 1 star = poor collaboration, 5 stars = excellent collaboration' },
    { id: 'FOOD&BEVERAGE', description: 'FOOD&BEVERAGE: assesses whether they treat colleagues respectfully and handle inter-departmental requests with professionalism and courtesy. 1 star = poor quality, 5 stars = excellent quality' },
    { id: 'HOUSEKEEPING', description: 'HOUSEKEEPING: evaluates whether they collaborate respectfully with other sectors and handle requests or interactions with professionalism and mutual respect. 1 star = messy, 5 stars = pristine' },
    { id: 'LAUNDRY', description: 'LAUNDRY: reflects how well they work with other sectors, whether they handle employee uniforms with care, and whether they show respect in their interactions. 1 star = bad service, 5 stars = excellent care' },
